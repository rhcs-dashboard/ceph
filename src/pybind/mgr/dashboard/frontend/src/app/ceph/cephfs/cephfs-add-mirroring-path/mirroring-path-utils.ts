...
export class MirroringPathUtils {
  ...
  static isRootPathSentinel(option: string): boolean {
    return MirroringPathUtils.isRootSelection(option);
  }
  ...
  /** Path cannot be selected because it overlaps an existing mirror path. */
