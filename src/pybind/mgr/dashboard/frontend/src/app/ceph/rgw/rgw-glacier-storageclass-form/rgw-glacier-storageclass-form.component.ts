...
export class RgwGlacierStorageclassFormComponent extends CdForm implements OnInit {
  ...
  createForm() {
    this.glacierStorageClassForm = this.formBuilder.group({
      glacier_restore_tier_type: [null, Validators.required],
  ...
  _getGlacierStorageClassArgs(): any {
    const formValues = {
      glacier_restore_tier_type: this.glacierStorageClassForm.get('glacier_restore_tier_type')
        .value,
